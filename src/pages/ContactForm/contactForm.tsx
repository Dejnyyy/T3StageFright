      ...
      >
        ...
        <div>
          <button
            ...
            className="w-full bg-black text-white border border-gray-300 font-semibold py-2 px-4 rounded-full hover:bg-white hover:text-black duration-300 ease-in-out disabled:bg-gray-400"
          >
            Submit
          </button>
        </div>
